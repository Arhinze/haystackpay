        ...
        if(isset($_POST["accept"])){
                ...
                if(!(empty($sel_ref_data->referred_by))){
                    ...
                    $message = <<<HTML
                        ...
                        <h2 style="color:#00008b;font-family:Arimo;text-align:center">$site_name</h2>
                            ...
                            <p>Kindly visit the <b><a href="https://$site_url_short/referred-users"  style="color:#ff3c00">Referred Users</a></b> page on your dashboard to view investors you've referred to us and the <b><a href="https://$site_url_short/referred-commissions"  style="color:#ff3c00">Referred Commissions</a></b> page to view your earnings.</p>
                            ...
                            <a href="https://$site_url_short/referred-commissions" style="color:#ff3c00;font-size:18px;padding:2%;border-radius:6px;box-shadow:0px 0px 3px #ff3c00;border:2px solid #ff3c00;width:8%;margin-left:30%;margin-right:20%">Referred Commissions</a>
                        </body>
                        </html>
            ...
            $message = <<<HTML
                ...
                <h2 style="color:#00008b;font-family:Arimo;text-align:center">$site_name</h2>
                    ...
                    <p>Kindly visit the <b><a href="https://$site_url_short/transactions"  style="color:#ff3c00">Transactions</a></b> page on your dashboard to confirm.</p>
                    ...
                    <a href="https://$site_url_short/transactions" style="color:#ff3c00;font-size:18px;padding:2%;border-radius:6px;box-shadow:0px 0px 3px #ff3c00;border:2px solid #ff3c00;width:8%;margin-left:30%;margin-right:20%">View Transactions</a>
                </body>
                </html>
            ...
            $mail = mail($_POST["userEmail"],"Approved $new_rqType Request On $site_name",$message, $headers);
