...
<?php
        ...
        echo "<div style='margin-top:30%;text-align:center;font-weight:bold;color:#ff9100;font-size:30px'>Access locked ): ~ <a href='https://wa.me/2348106961530'>contact the developer</a> to continue using.</div>";
    }
?>