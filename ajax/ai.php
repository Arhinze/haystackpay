...
if ($message = "send 5000 to Frances"){
    echo "<div id='pts' style='display:block;position:fixed;z-index:5;background-color:#fff;border-radius:6px;border:1px solid #2b8eeb;height:150px;width:70%;text-align:center;font-weight:bold;top:25%;left:5%'>Do you wish to send 5000 Naira to 0095000000 Access Bank - Francis Arinze Okoye ".'<div class="button" onclick=show_div("pts")>'."Yes, Proceed <i class='fa fa-arrow-right'></i></div></div>";
