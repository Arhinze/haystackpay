...
if ($message = "send 5000 to Francis"){
    return "<div style=$style>Do you wish to send 5000 Naira to 0095000000 Access Bank - Francis Arinze Okoye</div>";
} else if ($message = "send 5000 to Frances"){
    return "<div style=$style>Do you wish to send 5000 Naira to 0095000000 Access Bank - Francis Arinze Okoye</div>";
} else {
    return "<div style=$style>Sorry, this user is not a saved beneficiary</div>";
}
