...
$linkedin_file = trim(htmlentities(file_get_contents($_SERVER["DOCUMENT_ROOT"]."/static/files/linkedin_23feb_1march.csv")));
...
<body>
    ...
    <div>
        ...
        ?>
            <div style="margin:60px 3px"><a class="long-action-button" style="background-color:blue;color:#fff;" href="/melissa_2march_8march"> <i class="fa fa-search"></i> &nbsp; Search by managers >> </a></div>
        </div>
    </div>
</body>
</html>