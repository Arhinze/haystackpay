        ...
        public static function body($site_name = SITE_NAME_SHORT, $site_url = SITE_URL){
            ...
            echo <<<HTML
                <div class="haystackpay_intro">
                    ...
                    <div>Speak, Type or Snap to pay. Make transfer to multiple people at once. Receive AI powered financial analysis of your spending habit - all in one app.</div>
