...
HTML;
    ...
    public static function dashboard_body_top() {
        echo <<<HTML
            ...
            <span id="coming_soon" style="display:none" class="pop_up">
                This feature is coming soon <span style='float:right;position:absolute;top:6px;right:6px'> <i class='fa fa-times' onclick="close_hiddenCS()"></i></span>
            </span>
        HTML;
    }
