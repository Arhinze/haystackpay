...
<body>
    ...
    <div>
        ...
        ?>
            <div style="margin:30px 3px"><a class="long-action-button" style="background-color:blue;color:#fff;" href="/melissa_2march_8march"> <i class="fa fa-search"></i> &nbsp; Search by managers >> </a></div>
        </div>
    </div>
</body>
</html>