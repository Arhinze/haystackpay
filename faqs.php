...
Please note that the activation of the investment package occurs after the 4th confirmation of the Blockchain system.If, after confirmation, the package is not activated, in this case, please, check that the amount sent is correct, taking into account the commission. You can also clarify all the information on your account with our support specialists at <a href="mailto:support@vertextradeinvestment.com">support@vertextradeinvestment.com</a>
</div>
